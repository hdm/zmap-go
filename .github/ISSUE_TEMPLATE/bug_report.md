...
> Notice: Please don't file a bug report for questions on how to use ZMap, etc. Check out our [Resources](https://github.com/hdm/zmap-go/tree/main#resources) section for FAQ and feel free to chime in on [Github Discussions](https://github.com/hdm/zmap-go/discussions) if you're still unclear and we'll be happy to assist!
